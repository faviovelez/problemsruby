...
# El resultado de este ejercicio debería quedar:[:verde, :amarillo, nil, :azul, :verde, :amarillo ….]
require 'pry'
first = [1,2,3,0,1,2,2,1,2,1,2,0,3]
second = [:azul, :verde, :amarillo]

first.each_with_index do |i, n|
	if first[n] <= second.length
		first[n] = second[i]
	else 
		first[n] = nil
	end
